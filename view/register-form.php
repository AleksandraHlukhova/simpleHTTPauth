...
<body>
    <div class="container">
        ...
        <form action="./register.php" method="post" enctype="application/x-www-form-urlencoded" class="form">
            ...
            <input type="password" name="password" class="input-data" id="password"
                value="<?= (isset($_SESSION['pass'])) ? $_SESSION['pass'] : '' ?>" placeholder="Put your password">
            <label for="password-rep">Repeat password</label>
            <input type="password" name="password-rep" class="input-data" id="password-rep"
                value="<?= (isset($_SESSION['pass-rep'])) ? $_SESSION['pass-rep'] : '' ?>"
